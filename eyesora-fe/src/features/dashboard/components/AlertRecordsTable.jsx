                                ...
                                <tr key={index} className="hover:bg-blue-50/30 transition-colors duration-150">
                                    ...
                                    <td className="px-6 py-4 text-center align-middle">
                                        {isSevereMyopia && isHighAstigmatism ? (
                                            <span
                                                className="inline-flex px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wide bg-gradient-to-l from-red-500 to-red-800 text-white border border-red-500 whitespace-nowrap shadow-xs">
                                                Cận & Loạn Cao
                                            </span>
                                        ) : isSevereMyopia ? (
                                            <span
                                                className="inline-flex px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wide bg-gradient-to-l from-orange-500 to-orange-800 text-white border border-orange-500 whitespace-nowrap shadow-xs">
                                                Cận nặng
                                            </span>
                                        ) : isHighAstigmatism ? (
                                            <span
                                                className="inline-flex px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wide bg-gradient-to-l from-amber-200 to-amber-600 text-amber-950 border border-amber-400 whitespace-nowrap shadow-xs">
                                                Loạn thị cao
                                            </span>
                                        ) : null}
                                    </td>
