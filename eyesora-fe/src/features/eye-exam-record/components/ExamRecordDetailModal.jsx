                    ...
                    <div className="flex items-center justify-between bg-gray-50/90 p-4 rounded-2xl border border-gray-200/80">
                        ...
                        <div>
                            {isSevereMyopia && isHighAstigmatism ? (
                                <span className="inline-flex px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-wide bg-gradient-to-l from-red-500 to-red-800 text-white border border-red-500 shadow-xs">
                                    Cận & Loạn Cao
                                </span>
                            ) : isSevereMyopia ? (
                                <span className="inline-flex px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-wide bg-gradient-to-l from-orange-500 to-orange-800 to-orange-600 text-white border border-orange-500 shadow-xs">
                                    Cận nặng
                                </span>
                            ) : isHighAstigmatism ? (
                                <span className="inline-flex px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-widebg-gradient-to-l from-amber-200 to-amber-600 text-amber-950 border border-amber-400 shadow-xs">
                                    Loạn thị cao
                                </span>
                            ) : (
